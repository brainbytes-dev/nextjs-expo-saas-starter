...
const CATEGORY_KEYS = [
  {
    id: "accounting",
    labelKey: "intCatAccounting",
    descKey: "intCatAccountingDesc",
    integrations: [
  ...
  {
    id: "construction",
    labelKey: "intCatConstruction",
    descKey: "intCatConstructionDesc",
    integrations: [
  ...
  {
    id: "healthcare",
    labelKey: "intCatHealthcare",
    descKey: "intCatHealthcareDesc",
    integrations: [
  ...
  {
    id: "fleet",
    labelKey: "intCatFleet",
    descKey: "intCatFleetDesc",
    integrations: [
  ...
  {
    id: "communication",
    labelKey: "intCatCommunication",
    descKey: "intCatCommunicationDesc",
    integrations: [
  ...
  {
    id: "automation",
    labelKey: "intCatAutomation",
    descKey: "intCatAutomationDesc",
    integrations: [
  ...
  {
    id: "hardware",
    labelKey: "intCatHardware",
    descKey: "intCatHardwareDesc",
    integrations: [
...
function IntegrationPlaceholder({
  name, desc, color, short, badge, inDevLabel,
}: { name: string; desc: string; color: string; short: string; badge?: string; inDevLabel: string }) {
  return (
    <div
  ...
  return (
    <div className="space-y-10 px-4 py-4 md:px-6 md:py-6 lg:px-8 lg:py-8">
      ...
      <div>
        ...
        <h1 className="text-2xl font-semibold tracking-tight">{t("intPageTitle")}</h1>
        ...
        <section key={cat.id}>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {cat.integrations.map(i => (
              <IntegrationPlaceholder key={i.name} {...i} inDevLabel={t("intInDevelopment")} />
            ))}
          </div>
        </section>
      ))}
      ...
      <section className="border border-dashed border-border rounded-xl p-6 text-center">
        <p className="text-sm font-medium mb-1">{t("intMissingTool")}</p>
