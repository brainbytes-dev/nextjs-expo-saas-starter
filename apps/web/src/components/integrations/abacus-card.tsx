    ...
    <Card className="relative overflow-hidden border-border/60 transition-shadow hover:shadow-md">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-xs mt-0.5">
                Schweizer ERP — Artikel-Sync und Lagerbewegungen
              </CardDescription>
            </div>
          </div>
      ...
      <CardContent className="space-y-4">
        <p className="text-xs text-muted-foreground leading-relaxed">
          Materialien automatisch als AbaNinja-Artikel synchronisieren. Lagerbewegungen fliessen
          ...
          {connected ? (
            <>
              ...
              <Button
                ...
                aria-label="Abacus-Verbindung trennen"
              >
        ...
        {!isConfigured && (
          <div className="flex items-start gap-1.5 pt-1">
            ...
            <p className="text-[10px] font-mono text-muted-foreground/70">
              ABACUS_CLIENT_ID und ABACUS_CLIENT_SECRET in .env.local eintragen
            </p>
          </div>
        )}
      </CardContent>
