...
export default function SettingsScreen() {
  ...
  const DATA: (SettingsItem | string)[] = [
    ...
    },
    {
      ...
      leftView: <IconView name="shield.fill" className="bg-green-600" />,
      onPress: () => router.push("/(app)/settings/two-factor"),
    },
    {
      id: "language",
      title: "Sprache",
      leftView: <IconView name="globe" className="bg-teal-500" />,
      rightText: "Deutsch",
    ...
    },
    {
      ...
      leftView: <IconView name="desktopcomputer" className="bg-amber-500" />,
    ...
    "Werkzeuge",
    {
      id: "time-tracking",
      title: "Zeiterfassung",
      leftView: <IconView name="clock.fill" className="bg-purple-500" />,
      onPress: () => router.push("/(app)/time-tracking" as any),
    },
    {
      id: "ai-chat",
      title: "KI-Assistent",
      leftView: <IconView name="bubble.left.and.bubble.right.fill" className="bg-sky-500" />,
      onPress: () => router.push("/(app)/ai-chat" as any),
    },
    {
      id: "shift-handover",
      title: "Schichtuebergabe",
      leftView: <IconView name="arrow.left.arrow.right" className="bg-amber-500" />,
