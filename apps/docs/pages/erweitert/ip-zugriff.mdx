...
Die IP-Zugriffsbeschränkung (IP Allowlisting) erlaubt den Zugang zu **ZEN**TORY nur von definierten IP-Adressen oder Netzwerkbereichen. Ideal für Unternehmen, die den Zugriff auf das Firmennetzwerk beschränken möchten.
